...
@section('content')
    ...
    <section
        class="swiper heroSwiper max-h-[80vh] min-h-[70vh] lg:h-[100vh] bg-gradient-to-r from-blue-900 to-blue-700 text-white overflow-hidden flex items-center py-8">
        <div class="swiper-wrapper">
            <!-- Slide 1 -->
            <div class="swiper-slide flex items-center py-2 md:py-20">
                <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-12 items-center">
                    <div class="order-2 md:order-1 text-center md:text-left">
                        ...
                        <p class="mt-4 md:mt-6 text-base md:text-lg text-gray-200 text-pretty">
                            Delivering tailored solutions that drive lasting change and transform communities.
                        </p>
                        <div class="mt-8">
                            <button
                                class="bg-yellow-500 hover:bg-yellow-400 text-black px-8 py-3 rounded-lg font-bold transition-all transform hover:scale-105 active:scale-95 shadow-lg">
                                Learn More
                            </button>
                        </div>
                    </div>
                    <div class="order-1 md:order-2 flex justify-center md:justify-end">
                        <div class="relative w-full max-w-[220px] sm:max-w-md lg:max-w-lg lg:translate-x-12">
                            <img src="{{ asset('assets/img/static.png') }}"
                                class="w-full h-auto hover:rotate-0 transition duration-500" alt="static">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-12 items-center">
                    <div class="order-2 md:order-1 text-center md:text-left">
                        <h1 class="text-2xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                            ...
                            <span class="text-yellow-400">Focus on Technology & Expertise</span>
                        </h1>
                        <p class="mt-4 md:mt-6 text-base md:text-lg text-gray-200 text-pretty">
                            We build the software and infrastructure that powers modern enterprises and scales your vision.
                        </p>
                        <div class="mt-8">
                            <button
                                class="bg-yellow-500 hover:bg-yellow-400 text-black px-8 py-3 rounded-lg font-bold transition-all transform hover:scale-105 active:scale-95 shadow-lg">
                    ...
                    <div class="order-1 md:order-2 flex justify-center md:justify-end">
                        <div class="relative w-full max-w-[220px] sm:max-w-md lg:max-w-lg lg:translate-x-12">
                            <img src="{{ asset('assets/img/hero2.png') }}"
                                class="w-full h-auto hover:rotate-0 transition duration-500" alt="Hero 2">
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="swiper-pagination !bottom-3 md:!bottom-10"></div>
    </section>
    ...
    <section class="py-14 bg-gray-100">
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <div class="grid md:grid-cols-4 gap-6">
                ...
                <!-- Card 1 -->
                <div data-aos="zoom-in" class="bg-white p-6 rounded-xl shadow hover:shadow-lg transition text-center">
    ...
    <section class="py-14 bg-gray-200">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="text-center mb-14">
                <p class="text-blue-600 uppercase tracking-wide">
                    Our Services
                </p>
                <h2 class="text-3xl font-bold mt-2 mb-10">
                ...
                @foreach ($services as $service)
                    <div data-aos="fade-up"
                        ...
                        <div class="p-6">
                            ...
                            <!-- Button -->
                            <a href="{{ route('services') }}" class="text-blue-600 font-medium hover:underline">
                                Learn More →
                            </a>
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div data-aos="zoom-in"
                    class="group bg-white p-8 rounded-3xl shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border border-gray-100 flex flex-col h-full">
                    <div class="flex justify-center mb-8">
                        <!-- Icon Container: Perfect Circle with Hover Sync -->
                        <div
                            class="w-20 h-20 bg-blue-50 text-blue-600 rounded-full flex items-center justify-center transition-all duration-500 group-hover:bg-blue-600 group-hover:text-white group-hover:scale-110 shadow-inner">
                            <svg xmlns="http://w3.org" class="w-10 h-10" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                                    d="M17 20h5v-1a4 4 0 00-5-3.87M9 20H4v-1a4 4 0 015-3.87m8-5a4 4 0 11-8 0 4 4 0 018 0zM5 7a4 4 0 118 0 4 4 0 01-8 0z" />
                            </svg>
                    ...
                    <h3
                        class="font-bold text-xl text-slate-800 mb-4 transition-colors duration-300 group-hover:text-blue-600">
                    ...
                    <div class="pt-6 border-t border-gray-50">
                        <a href="#"
                            class="text-blue-600 font-bold inline-flex items-center hover:gap-2 transition-all">
                            Learn More
    ...
    <section class="py-14 bg-gray-100">
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div>
                ...
                <h2 class="text-3xl font-bold mt-2 mb-10 text-left md:text-left">
                ...
                <div class="flex flex-wrap gap-3 mt-6">
                    <span data-aos="zoom-in"
                        class="bg-blue-100 text-blue-800 px-4 py-1.5 rounded-full text-sm font-bold">.NET</span>
                    <span data-aos="zoom-in"
                        class="bg-blue-100 text-blue-800 px-4 py-1.5 rounded-full text-sm font-bold">PHP</span>
                    <span data-aos="zoom-in"
                        class="bg-blue-100 text-blue-800 px-4 py-1.5 rounded-full text-sm font-bold">Oracle</span>
                    <span data-aos="zoom-in"
                        class="bg-blue-100 text-blue-800 px-4 py-1.5 rounded-full text-sm font-bold">MySQL</span>
                </div>
